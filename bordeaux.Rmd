...
saintMarieDeLaBastide <- paste("<b>Église Saint-Marie de la Bastide</b>")
library(leaflet)
...
leaflet() %>% addTiles() %>%
  ...
  addMarkers(-0.556614, 44.843008, icon = greenDotIcon, popup = saintMarieDeLaBastide) # Église Saint-Marie de la Bastide
```

```{r echo = FALSE, results = 'asis'}
titles <- c("Length of Stay", "Major Sights", "Unique Foods", "Restaurant Recommendations")
values <- c("Two years", "Saint-Andre Cathedral, Monument aux Girondins, Port de la Lune", "Cannelés", "Books & Coffee")
...
![](images/Bordeaux/bordeaux67.png)

Église Saint-Marie de la Bastide is a church designed by Paul Abadie, the same designer as Sacré-Cœur in Paris. The church is located in the Bastide neighborhood, across the Garonne river from the historic center of Bordeaux. The neighborhood was originally a separate town, but was annexed by the city in 1865. The church was built in the 19th century, and is a popular wedding venue.

![](images/Bordeaux/bordeaux45.png)
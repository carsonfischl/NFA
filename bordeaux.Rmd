...
leaflet() %>% addTiles() %>%
  ...
  addMarkers(-0.577783, 44.837643, icon = greenDotIcon) %>% # Cathédrale Saint-André 
  addMarkers(-0.562718, 44.838486, icon = greenDotIcon) %>% # Pont de Pierre
  addMarkers(-0.571353, 44.835441, icon = greenDotIcon) %>% # Grosse Cloche
  addMarkers(-0.570022, 44.841486, icon = greenDotIcon) %>% # Place de la Bourse
  addMarkers(-0.568502, 44.838760, icon = greenDotIcon) %>% # Porte Cailhau
  addMarkers(-0.573656, 44.842591, icon = greenDotIcon) %>% # Grande Théatre
  addMarkers(-0.582942, 44.847789, icon = greenDotIcon) %>% # Palais Gallien
  addMarkers(-0.559062, 44.869907, icon = greenDotIcon) %>% # Sub base
  addMarkers(-0.556076, 44.825665, icon = greenDotIcon) %>% # Gare Saint-Jean
  addMarkers(-0.574845, 44.845318, icon = greenDotIcon) %>% # Monument aux Girondins
  addMarkers(-0.566232, 44.836318, icon = greenDotIcon) # Porte de Bourgogne
```

...
library(leaflet)
leaflet() %>% addTiles() %>%
  setView(0.131177, 49.495933, zoom = 14) %>%
...
La Havre and the town on the opposite side of the river, Honfleur, sit at the mouth of the Seine and were major ports during the Hundred Years War and the Viking invasions. Normandy is a major artistic centre since the Impressionist movement and the local galleries have works from many famous painters.

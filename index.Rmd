...
leaflet() %>% addTiles() %>%
  ...
  # Greece
  addMarkers(25.2711, 36.7286, icon = greenDotIcon, popup = mykonosCont) %>% # Mykonos, Greece
  addMarkers(25.4283, 36.3932, icon = greenDotIcon, popup = santoriniCont) %>% # Santorini, Greece
  # Netherlands
  ...
  addMarkers(-1.980055, 43.317613, icon = greenDotIcon, popup = sanSebastianCont) %>%
  # Asia
  # Turkiye

...
library(leaflet)
bayonneCont <- paste("<a href='./bayonne.html'>Bayonne, France</a>")
bordeauxCont <- paste("<a href='./bordeaux.html'>Bordeaux, France</a>")
...
thumbnail("Biarritz, France", "images/Biarritz/biarritz1.png", "./biarritz.html")
thumbnail("Bordeaux, France", "images/Bordeaux/bordeaux2", "./bordeaux.html")
```
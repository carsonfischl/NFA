...
leaflet() %>% addTiles() %>%
  ...
  addMarkers(-71.9794, -13.5152, icon = greenDotIcon, popup = rainbowMountainCont) %>% # Rainbow Mountain, Peru
  addMarkers(-76.2508, -13.8409, icon = greenDotIcon, popup = arequipaCont) # Arequipa, Peru
```

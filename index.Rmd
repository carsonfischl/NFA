...
leaflet() %>% addTiles() %>%
  ...
  # Africa
  # Morocco
  addMarkers(-9.765129, 31.508956, icon = greenDotIcon) %>% # Essaouira, Morocco
  addMarkers(-7.987035, 31.627309, icon = greenDotIcon) %>% # Marrakesh, Morocco
  addMarkers(-4.014088, 31.099917, icon = greenDotIcon, popup = merzougaCont) %>% # Merzouga, Morocco
  addMarkers(-6.919241, 30.924812, icon = greenDotIcon) %>% # Ouarzazate, Morocco
  # Europe
  # Belgium
...
thumbnail("Merzouga", "images/Merzouga/merzouga37.png", "./merzouga.html")
``` 
<br />
<br />
<br />
...
thumbnail("Mostar", "images/Mostar/mostar2.png", "./mostar.html")
```
<br />
<br />
<br />
...
thumbnail("Dubrovnik", "images/Dubrovnik/dubrovnik13.png", "./dubrovnik.html")
thumbnail("Split", "images/split/split4.png", "./split.html")
```
<br />
<br />
<br />
...
thumbnail("Bayonne", "images/Bayonne/bayonne1.png", "./bayonne.html")
thumbnail("Biarritz", "images/Biarritz/biarritz7.png", "./biarritz.html")
thumbnail("Bordeaux", "images/Bordeaux/bordeaux2.png", "./bordeaux.html")
thumbnail("Langon", "images/Langon/langon8.png", "./langon.html")
thumbnail("La Rochelle", "images/LaRochelle/larochelle5.png", "./la-rochelle.html")
thumbnail("Le Havre", "images/LeHavre/lehavre8.png", "./le-havre.html")
thumbnail("Lille", "images/Lille/lille7.png", "./lille.html")
thumbnail("Mont-Saint-Michel", "images/MontSaintMichel/msm1.png", "./mont-saint-michel.html")
thumbnail("Saint-Émilion", "images/SaintEmilion/saintemilion17.png", "./saint-emilion.html")
```
<br />
<br />
<br />

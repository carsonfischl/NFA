...
leaflet() %>% addTiles() %>%
  ...
  addMarkers(-1.471736, 43.494345, icon = greenDotIcon) %>%  # Pont Saint-Esprit
  addMarkers(-1.477291, 43.490524, icon = greenDotIcon) %>%  # Cathédrale Saint-Marie
  addMarkers(-1.470280, 43.497037, icon = greenDotIcon) # Gare Saint-Esprit
```
...
The [Pont Saint-Esprit](https://fr.wikipedia.org/wiki/Pont_Saint-Esprit_(Bayonne\)) was finished in 1849 and connects the train station to the Little Town.